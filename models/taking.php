...
<<<<<<< HEAD
		$result = $wpdb->get_var($wpdb->prepare("SELECT result FROM ".WATUPRO_TAKEN_EXAMS." 
...
<<<<<<< HEAD
		...
		$avg_percent_text = empty($atts['avg_percent_text']) ? __('Avg. %d%% correct', 'watupro') : $atts['your_percent_text'];
		$your_points_text = empty($atts['your_points_text']) ? __('Your points: %s', 'watupro') : $atts['your_points_text'];
		$avg_points_text = empty($atts['avg_points_text']) ? __('Avg. points: %s', 'watupro') : $atts['avg_points_text'];
...
<<<<<<< HEAD
			$content .= '<td style="vertical-align:bottom;"><table class="watupro-basic-chart-points"><tr>';
=======
...
<<<<<<< HEAD
			$content .='<td align="center" style="vertical-align:bottom;">';
			$content .= '<div style="background-color:'.$your_color.';width:'.$width.'px;height:'.round($points_step * $taking->points). 'px;">&nbsp;</div>'; 
			$content .='</td>';
			if(empty($atts['average']) or $atts['average'] == 'show') {
				$content .= '<td align="center" style="vertical-align:bottom;">';
				$content .= '<div style="background-color:'.$avg_color.';width:'.$width.'px;height:'.round($points_step * $avg_points). 'px;">&nbsp;</div>';
=======
			$content .='<td align="center" style="vertical-align:bottom;text-align:center;">';
...
<<<<<<< HEAD
					$content .='<td align="center">' . $overview_points_text . '</td>';
=======
...
>>>>>>> branch/6.7.2
			...
			// latest attempt
<<<<<<< HEAD
			$content .='<td align="center">' . $your_points_text . '</td>';
			
			// average
			if(empty($atts['average']) or $atts['average'] == 'show') $content .='<td align="center">'. $avg_points_text .'</td>';
=======
		...
		if($show == 'percent' or $show == 'both') {
			...
			if(!empty($show_overview)) {
				foreach($takings as $t) {
					$content .='<td align="center" style="vertical-align:bottom;">';
<<<<<<< HEAD
					$content .= '<div style="background-color:'.$your_color.';width:'.$width.'px;height:'.round($points_step * $t->percent_correct). 'px;">&nbsp;</div>'; 
=======
...
>>>>>>> branch/6.7.2
			...
			$content .= '<td align="center" style="vertical-align:bottom;">';
<<<<<<< HEAD
			$content .= '<div style="background-color:'.$your_color.';width:'.$width.'px;height:'.round($step * $taking->percent_correct). 'px;">&nbsp;</div>'; 
			$content .='</td>';
			if(empty($atts['average']) or $atts['average'] == 'show') {
				$content .= '<td align="center" style="vertical-align:bottom;">';
				$content .= '<div style="background-color:'.$avg_color.';width:'.$width.'px;height:'.round($step * $avg_percent). 'px;">&nbsp;</div>';
=======
...
<<<<<<< HEAD
					$content .='<td align="center">' . $overview_percent_text . '</td>';
=======
...
>>>>>>> branch/6.7.2
			...
			// latest attempt
<<<<<<< HEAD
			$content .='<td align="center">' . $your_percent_text . '</td>';
			
			if(empty($atts['average']) or $atts['average'] == 'show')  $content .= '<td align="center">'. $avg_percent_text .'</td>';
=======
...
<<<<<<< HEAD
		if(empty($exam_id)) $exam_id = $wpdb->get_var($wpdb->prepare("SEELCT exam_id FROM ".WATUPRO_TAKEN_EXAMS." WHERE ID=%d", $taking_id));
=======
...
=======
	...
	public static function answers_table($taking_id, $media = 'screen') {
		...
		ob_start();	
		if(@file_exists(get_stylesheet_directory().'/watupro/groups.php')) require get_stylesheet_directory().'/watupro/answers-table.html.php';
		else require(WATUPRO_PATH . "/views/answers-table.html.php");
