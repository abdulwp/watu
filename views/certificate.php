<div class="wrap watupro-wrap">
	...
	<p><label><?php _e('Background color of the certificate:', 'watupro');?></label> <input type="text" name="bgcolor" value="<?php echo empty($certificate->bgcolor) ? '#FFFFFF' : $certificate->bgcolor?>" class="color-field"> <em><?php printf(__('<b>This will have no effect if your certificate is already containing a full HTML document.</b> For more robust design you may need to use HTML or some of our <a href="%s" target="_blank">free certificate templates</a>', 'watupro'), 'http://blog.calendarscripts.info/free-certificate-templates-for-watupro/')?></em></p>	
	...
	<tr><td>%%URL%%</td><td><?php _e('If your certificates are accessible to the public, you can use this variable to display the certificate URL for sharing on social networks.', 'watupro') ?></td></tr>
