...
<div id="watuproContactDetails-<?php echo $exam->ID?>-<?php echo $position?>" style="display:<?php echo ($position == 'start') ? 'block' : 'none';?>;" class="watupro-ask-for-contact watupro-ask-for-contact-quiz-<?php echo $exam->ID?>">
	<?php if(!empty($advanced_settings['contact_fields']['intro_text'])) echo wpautop(stripslashes(base64_decode($advanced_settings['contact_fields']['intro_text'])));?>
	...
	<?php endif;?></div>
=======
<div id="watuproContactDetails-<?php echo $exam->ID?>-<?php echo $position?>" style='display:<?php echo ($position == 'start') ? 'block' : 'none';?>;' class="watupro-ask-for-contact watupro-ask-for-contact-quiz-<?php echo $exam->ID?> <?php if(!empty($advanced_settings['is_rtl'])):?>watupro-rtl<?php endif;?>">
	...
	<?php if(!empty($advanced_settings['contact_fields']['field1'])):?>
		<p class="watupro-contact-field-wrap watupro-contact-field-field1-wrap"><?php echo $advanced_settings['contact_fields']['field1_label'];?> <br>
	...
	<?php if(!empty($advanced_settings['contact_fields']['field2'])):?>
		<p class="watupro-contact-field-wrap watupro-contact-field-field2-wrap"><?php echo $advanced_settings['contact_fields']['field2_label'];?> <br>
