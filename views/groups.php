...
=======
			<p class="watupro-wrap">
				<label class="id_label"><?php _e('ID:', 'watupro');?> <?php echo $group->ID?> |</label>
...
>>>>>>> branch/6.7.2
				...
				&nbsp;
<<<<<<< HEAD
				<a href="admin.php?page=watupro_group_assign&group_id=<?php echo $group->ID?>"><?php _e('Mass asssign users', 'watupro');?></a>
			</div>
=======
