...
<p><?php _e('(All the variables can be used in grade descriptions as well.)', 'watupro')?></p>
	...
	<tr><td>%%ANSWERS-NOFEEDBACK%%</td><td><?php _e('Same as above but without the "optional answer explanation" contents.', 'watupro');?></td></tr>
	<tr><td>%%FEEDBACK-NOANSWERS%%</td><td><?php _e('The reverse of the above variable - will include the question and the optional answer explanation, but will not repeat the question choices showing the user answer. Typically used when you manually craft the feedback on all questions accordingly to each possible answer.', 'watupro');?></td></tr>
	<tr><td>%%ONLYFEEDBACK%%</td><td><?php _e('Only the question explanation / feedback without any questions or answers info. Be careful to craft the feedback in a way that makes sense.', 'watupro');?></td></tr>
	<?php if(empty($edit_mode)):?>
