<div class="wrap watupro-wrap">
	...
	<?php if(count($certificates)):?>
		<table class="widefat">
			<thead>
		<tr><th><a href="admin.php?page=watupro_certificates&ob=ID&dir=<?php echo $ob === 'ID' ? $odir : $dir?>"><?php _e('ID','watupro');?></a></th>
		<th><a href="admin.php?page=watupro_certificates&ob=title&dir=<?php echo $ob === 'title' ? $odir : $dir?>"><?php _e('Certificate Title', 'watupro')?></a></th><th><?php _e('Users earned', 'watupro')?></th><th><?php _e('Edit', 'watupro')?></th></tr>
		</thead>
	...
	<p><input type="checkbox" name="obfuscate_certificate_ids" value="1" <?php if(get_option('watupro_obfuscate_certificate_ids') == '1') echo 'checked'?>> <?php _e('Allow only obfuscated certificate IDs in the URL (If you leave this unchecked the old way of directly passing numeric taking_id in the URL will still work for backward compatibility).', 'watupro')?>  </p>	
