...
class WatuPROITeacherController {
	...
	static function edit_taking() {
		...
		if($multiuser_access == 'view_approve' or $multiuser_access == 'group_view_approve') $restrict_emailing = WatuPROIMultiUser::check_access('view_approve_restrict_emailing', true);
