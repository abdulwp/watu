...
=======
					<?php endif;?>
					<br><?php printf(__('List of %s', 'watupro'), WATUPRO_QUIZ_WORD_PLURAL);?> <input type="text" value='[watupro-bundle-list id="<?php echo $bundle->ID?>"]' onclick="this.select();" readonly="readonly" size="40"></td>
