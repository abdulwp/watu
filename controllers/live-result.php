...
=======
	$ansArr = (isset($_POST["answer-" . $ques->ID]) and is_array( $_POST["answer-" . $ques->ID] )) ? $_POST["answer-" . $ques->ID] : array(); 
...
=======
		$answer = isset($_POST['answer-'.$_POST['question_id']]) ? serialize($_POST['answer-'.$_POST['question_id']]) : ''; // we need to store the serialized answer here
>>>>>>> branch/6.7.2
